...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('metronic::global/css/components-md.min.css') }}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{ asset('metronic::layouts/layout2/css/themes/blue.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="{{ asset('metronic::layouts/layout2/img/logo-default.png') }}" alt="logo" class="logo-default" /> </a>
